@echo off
echo ------------------------------------------------------
echo   KiaraGale's Sonic Mania Android Build Helper v2.4b
echo ------------------------------------------------------
echo.
echo                                                  WARNING:
echo.
...
git clone https://github.com/tariq-nasheed/HyperMania "%USERPROFILE%"\Documents\Sonic-Mania-Android-Sheeple\HyperMania
cd "%USERPROFILE%"\Documents\Sonic-Mania-Android-Sheeple\HyperMania\src
cd "%USERPROFILE%"\Documents\Sonic-Mania-Android-Sheeple\GameAPI
xcopy "%USERPROFILE%"\Documents\Sonic-Mania-Android-Sheeple\GameAPI "%USERPROFILE%"\Documents\Sonic-Mania-Android-Sheeple\HyperMania\src\GameAPI /s /y /i
pause
...
if /I %hypermania%==y mklink /D "HyperMania" "%USERPROFILE%"\Documents\Sonic-Mania-Android-Sheeple\HyperMania\src
